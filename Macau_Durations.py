...
parser.add_argument('--latents',default=70,type=int,help="Number of latent dimensions")
parser.add_argument('--samples',default=200,type=int,help="Number of samples after burnin")
parser.add_argument('--burnin',default=200,type=int,help="Number of burnin samples")

opt=parser.parse_args()

log_name=f"Nested_ICU_latents{opt.latents}"
...
tags=pd.read_csv(files_path+"complete_death_tags.csv").sort_values("UNIQUE_ID")[["DEATHTAG","UNIQUE_ID"]].values[:,0]
