...
def run_macau(num_latents,num_samples,num_burnin,tensor,covariates):
    ...
    summary_dict={'N_samples':N,"N_latents":num_latents,"Segmented":segmented}
...
if __name__=="__main__":
    run_macau(num_latents=opt.latents,num_samples=opt.samples,num_burnin=opt.burnin)
